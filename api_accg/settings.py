...
SECRET_KEY = 'django-insecure-evf7+w&$g^ejwp+=2q99(bvcawh5&w9lwk%#b=dpk6)@*3!m-o'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'kaymmiknb@gmail.com'
EMAIL_HOST_PASSWORD = 'oriq aofm jiew luxt' # Senha de app do Gmail